    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form action="inserts/preguntasfrecuentes.php" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            try {
                                ...
                                // Mostrar los datos
                                echo "<h3 class='text-center'>Preguntas Frecuentes</h3>";
                                ...
                                foreach ($documents as $document) {
                                    ...
                                    echo "<td><a class='btn' href='editar-pregunta.php?id=" . $document['_id'] . "'>Editar</a></td>";
                                    echo "<td><a class='btn' href='deletes/pregunta.php?id_pregunta=" . $document['_id'] . "' onclick='return confirm(\"¿Estás seguro de eliminar esta pregunta frecuente?\")'>Eliminar</a></td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
                                echo "</table>";
