    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="card">
                    <div class="card-body">
                        <form action="inserts/administradores.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="rol" name="rol" required>
                                    ...
                                    <option value="gestor">Gestor de asesorias</option>
                                </select>
                            </div>
                        ...
                        <div class="col-12">
                            ...
                            try {
                                ...
                                foreach ($documents as $document) {
                                    ...
                                    echo "<td>" . $document['rol'] . "</td>";
                                    echo "<td><a class='btn' href='deletes/administradores.php?id_usuario=" . $document['_id'] . "' onclick='return confirm(\"¿Estás seguro de eliminar este usuario?\")'>Eliminar</a></td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
                                echo "</table>";
